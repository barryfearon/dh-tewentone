    ...
    <div className={`${styles.LineupPageContent} d-flex flex-column justify-content-between`}>
      ...
      <Row>
        <Col sm={12} lg={4}>
          <div className='d-flex flex-column flex-lg-row justify-content-around mb-5 mb-lg-0'>
            <div className='d-flex flex-column align-items-center my-2'>
              <h2 className='display-4'>Friday 22nd July</h2>
        ...
        <Col sm={12} lg={4}>
          <div className='d-flex flex-column flex-lg-row justify-content-around mb-5 mb-lg-0'>
            <div className='d-flex flex-column align-items-center my-2'>
              <h2 className='display-4'>Saturday 23rd July</h2>
              <div className='text-center mb-2'>
                <h3>23:00</h3>
                <img
        ...
        <Col sm={12} lg={4}>
          <div className='d-flex flex-column flex-lg-row justify-content-around mb-5 mb-lg-0'>
            <div className='d-flex flex-column align-items-center my-2'>
              <h2 className='display-4'>Sunday 24th July</h2>
              <div className='text-center'>
                <h3>20:00</h3>
                <img
                  src='https://res.cloudinary.com/dark-horse-music/image/upload/v1646771028/bands%202022/Blair.jpg'
                  className='img-fluid w-50 mb-2'
                />
                <h3>Blair House Project</h3>
              </div>
              <div className='text-center mb-2'>
                <h3>18:00</h3>
                <img
