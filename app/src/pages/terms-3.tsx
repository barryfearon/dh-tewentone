...
const Terms: NextPage = () => (
  <MainLayout siteTitle='Dark Horse Music - Isle of Man' pageTitle='Terms &amp; Conditions'>
    <div className='row justify-content-center'>
      <div className='col-12 col-sm-10 col-md-8 col-lg-6'>
        <h1>Terms &amp; Conditions</h1>
        <h4>
          As a result of purchasing a ticket and entry onto the festival site, all ticket holders
        ...
        <ol>
          ...
          <li>
            <ol>
              ...
              <li>
                On completion, the new owner will be sent a copy of the updated ticket to the new
          ...
          <li>
            ...
            only. An extra charge will be incurred if participants remain on the campsite and are
            still found to be on the site after&nbsp;the&nbsp;
          ...
          <li>
            ...
            and having entered the site cannot leave until the&nbsp;
            <strong>24th July 2022</strong> when stewards will be available to direct the flow of
            traffic.
          </li>
          <li>
          ...
          <li>
            Designated camping areas will be marked out. Make sure you pay attention, you will be
            asked to move if you are outside of these areas.
          </li>
          <li>
          ...
          <li>
            Live in vehicles that require electricity will be directed to the appropriate area by
            the site staff. Availability is on a first come first serve basis.
          </li>
          <li>
            Do not leave money or valuables in your tents or cars as thieves sometimes operate in
            the camping areas.
          </li>
          <li>
            All ticket holders and crew agree to comply with any searches which designated festival
            security deem necessary to their person, vehicle, live in vehicle, luggage or equipment.
          </li>
          <li>Lasers and strobe lighting may be used at the festival.</li>
          <li>
            Be aware music played may well be in excess of 100 decibels and prolonged exposure can
            damage hearing especially to young children.
          </li>
          <li>
          ...
          <li>
            Under 18s including Teenage Ticket holders must be accompanied by an adult (aged over
            21) at all times.
          </li>
          <li>
            Children aged 12 years and under can attend the event for free when accompanied by an
          ...
          <li>
            Ticket holders consent to the filming, sound recording and photography of themselves as
            part of the audience.
          </li>
          <li>
            Tickets will not be refunded in any circumstances, other than the total cancellation of
            the event, when only the face value of the ticket will be refunded.
          </li>
          ...
          <li>
            Dark Horse Music Limited. has no liability for the loss or damage of vehicles, goods or
            other materials belonging to guests and crew attending the Dark Horse Music &amp; Arts
            Festival.
          </li>
          <li>
            You are permitted to bring alcohol for your own personal consumption into the camp-site
            but not into any <strong>licensed areas</strong> – this is a condition of our license.
          </li>
          <li>
            We reserve the right to refuse entry to anyone we suspect of bringing in alcohol not for
            personal consumption.
          </li>
          <li>
            It is illegal to sell alcohol to or purchase alcohol for anyone younger than 18 years of
            age. For licensing reasons people aged 17 and under must stay at least 2m away from any
            bar front on site. If you appear to be under 21 you will be asked for ID.
          </li>
        </ol>
      </div>
    </div>
